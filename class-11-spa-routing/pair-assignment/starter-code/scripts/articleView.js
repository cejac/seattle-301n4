(function(module) {
  ...
  // TO: Once the routes are handling "/" and "/about", we can delete this handleMainNav function. YESSSS!
  // TO: Remeber to also remove any calls to this function, wherever they may originate!
